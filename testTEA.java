...
public class testTEA{
	...
	public static void main(String[] args) throws IOException{
		...
		FileOutputStream imgOut = new FileOutputStream("C:\\Users\\sayed\\Desktop\\workspace\\Security\\src\\image\\result.bmp");
		...
		while(dataIn.available() > 0){
			try{
				...
				cipher = tea.encrypt(img);		//Passing the block to TEA algorithm to encrypt it
		...
		DataInputStream dataIn1 = new DataInputStream(new FileInputStream("C:\\Users\\sayed\\Desktop\\workspace\\Security\\src\\image\\result.bmp"));
		DataOutputStream dataOut1 = new DataOutputStream(new FileOutputStream("C:\\Users\\sayed\\Desktop\\workspace\\Security\\src\\image\\unencrypt.bmp"));
